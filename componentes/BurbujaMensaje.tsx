  ...
  return (
    <View
      style={[
        ...
        // si es Remitente es true tons aplica estilo de remitente osea el color verde
        // si no aplica estilo de receptor gris
      ]}
    >
      <Text>{texto}</Text>
      {/* muestra el texto dentro de la burbuja */}
    </View>
  );
};
...
// exportamos burbujaMensaje para q se pueda usar en otras pantallas
